...
public enum ErrorCodes {
    ...
    ROLE_NOT_FOUND("2036", "Role not found"),
    ROLE_NOT_BELONG_THIS_ORGANIZATION("2037", "Role does not belong to this organization"),
    ROLE_IS_NOT_ACTIVE("2038", "Role is not active"),
    USER_NOT_PENDING_STATUS("2039", "User is not in PENDING status"),
    FAILED_TO_ENROLLED_BLOCKCHAIN("2040", "Failed to enroll user on blockchain"),
    NO_FABRIC_ORG_AVAILABLE("2041", "Maximum capacity reached. No available Fabric organizations."),
    ORGANIZATION_NOT_ONBOARD("2042", "Organization not onboarded"),
    ORGANIZATION_HAS_NOT_TEMPLATE("2043", "Organization has no permission template"),
